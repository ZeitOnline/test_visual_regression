...
function adDefend() {
    ...
    AdDefend.prototype.renderTemplate = function() {
        ...
        var html = that.config.template({
            hl: that.responseObj.headline_notice,
            description: that.responseObj.description,
            btnDeactivate: that.responseObj.btn_deactivate,
            notice: that.responseObj.notice,
            hlManual: that.responseObj.hl_manual,
            listManual1: that.responseObj.list_manual1,
            listManual2: that.responseObj.list_manual2,
            listManual3: that.responseObj.list_manual3,
            btnReload: that.responseObj.btn_reload
        });
