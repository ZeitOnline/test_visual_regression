...
All calling templates have to provide:
    layout: to define type of leader (eg. 'upright', 'square', 'full')
...
<div class="{% block layout %}{% endblock %} {{ cp.advertorial_modifier(teaser.product_text, view.is_advertorial) | default('') }}">

    {# call comment box #}
    {% if self.layout() != 'teaser-fullwidth' -%}
