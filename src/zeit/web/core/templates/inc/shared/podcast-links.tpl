...
<ul class="podcastfooter__platforms podcast-links">
    ...
    <li class="podcast-links__item">
        <a class="podcast-links__link" href="{{ settings('itunes_podcast_base_url') ~ itunes_id }}" title="Podcast bei iTunes">{{ lama.use_svg_icon('itunes', 'itunes__icon', view.package) }}</a>
    </li>
    {% endif %}
    {% if spotify_url %}
    <li class="podcast-links__item">
        <a class="podcast-links__link" href="{{ spotify_url }}" title="Podcast bei Spotify">{{ lama.use_svg_icon('spotify', 'spotify__icon', view.package) }}</a>
    </li>
    {% endif %}
    {% if deezer_url %}
    <li class="podcast-links__item">
