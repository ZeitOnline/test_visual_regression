...
<nav class="footer-breadcrumbs">
    ...
    {% for breadcrumb in view.breadcrumbs %}
        ...
        <li class="footer-breadcrumbs__item" itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="itemscope">
            ...
            <a class="footer-breadcrumbs__link" itemprop="url" title="{{ bcrumb_title }}" href="{{ bcrumb_link | create_url}}" data-id="footer.breadcrumbs.{{ loop.index }}..{{ bcrumb_text | format_webtrekk }}">
