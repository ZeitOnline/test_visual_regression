...
<article class="{{ module_layout }}">
	...
	<div class="{{ module_layout }}__container-outer">
		<div class="{{ module_layout }}__container-inner">
			...
			<a class="{{ module_layout }}__button" title="{{ teaser.title }}: {{ teaser.text }}" href="{{ teaser.url }}" style="background-color:#{{ teaser.button_color }}" data-id="articlebottom.publisher-nextread...area-button">
				{{ teaser.button_text }}
			</a>
		</div>
	</div>
