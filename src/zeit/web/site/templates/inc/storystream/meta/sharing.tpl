...
<div class="{{ blockname }}">
	<div class="{{ blockname }}__container">
		<div class="{{ blockname }}__content">
			...
			<a class="{{ blockname }}__link {{ blockname }}__link--facebook" href="http://www.facebook.com/sharer/sharer.php?u={{ (content_url ~ ga_campaign).format('facebook') | urlencode }}" target="_blank" data-id="articlehead.1.1.social.facebook">
