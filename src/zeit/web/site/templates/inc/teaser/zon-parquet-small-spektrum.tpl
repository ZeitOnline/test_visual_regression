    ...
    {% if esi_toggle %}
        ...
        <figure class="teaser-parquet-small__media scaled-image">
            <div class="teaser-parquet-small__media-container">
                <a {% if track_slug %}id="{{ track_slug }}.3.{{ teaser_track_id }}.image|{{ teaser.url }}"{% endif %} class="teaser-parquet-small__media-link" title="{{ teaser.teaserTitle }}" href="{{ teaser.url }}">
