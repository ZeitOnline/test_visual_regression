<article class="teaser-parquet-small " data-block-type="teaser">
    {% if esi_toggle %}
        ...
        <figure class="teaser-parquet-small__media scaled-image">
            <div class="teaser-parquet-small__media-container">
                <a {% if track_slug %}id="{{ track_slug }}.3.{{ loop.cycle('a', 'b', 'c') }}.image|{{ teaser.url }}"{% endif %} class="teaser-parquet-small__media-link" title="{{ teaser.teaserTitle }}" href="{{ teaser.url }}">
    ...
    <div class="teaser-parquet-small__container ">
        <h2 class="teaser-parquet-small__heading">
            <a {% if track_slug %}id="{{ track_slug }}.3.{{ loop.cycle('a', 'b', 'c') }}.title|{{ teaser.url }}"{% endif %} class="teaser-parquet-small__combined-link" title="{{ teaser.teaserSupertitle }} - {{ teaser.teaserTitle }}" href="{{ teaser.url }}">
