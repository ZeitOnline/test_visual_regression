...
def test_printbox_is_present_and_has_digital_offerings(testbrowser, testserver):
...
def test_printbox_is_present_and_has_newsprint_offerings(testbrowser, testserver):
    uri = 'http://xml.zeit.de/angebote/print-box'
    content = zeit.cms.interfaces.ICMSContent(uri)
    with checked_out(content) as co:
        co.byline = ''
