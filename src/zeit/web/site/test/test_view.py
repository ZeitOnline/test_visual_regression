...
def test_login_state_view_should_deliver_correct_sso_urls(dummy_request):
    ...
    assert 'http://sso.example.org/registrieren?url=http://destination_sso&entry_service=sonstige' == r['register']
    assert ('http://sso.example.org/registrieren_email?template=rawr&url=http://destination_sso&entry_service=rawr' ==
            r['register_rawr'])
    assert 'http://sso.example.org/anmelden?url=http://destination_sso&entry_service=sonstige' == r['login']
    assert 'http://sso.example.org/abmelden?url=http://destination_sso&entry_service=sonstige' == r['logout']
